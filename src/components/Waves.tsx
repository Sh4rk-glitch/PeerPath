...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function tick(t: number) {
      ...
      // If paused (hero offscreen), skip heavy updates but keep RAF alive
      if ((pausedRef as any).value) {
    ...
    // IntersectionObserver to pause waves when offscreen
    const observer = new IntersectionObserver((entries) => {
      const e = entries[0]
      ;(pausedRef as any).value = !e.isIntersecting
